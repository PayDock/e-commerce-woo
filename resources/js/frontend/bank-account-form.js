...
import {checkboxSavedBankAccountComponent, selectSavedBankAccountsComponent} from '../includes/wc-plugin';
...
const Content = (props) => {
    ...
    return createElement('div',
        ...
        createElement(
            "div",
            {id: 'pluginWidgetBankAccount_wrapper'}
        ),
        createElement(
            "input",
            {
...
const PaydokBankAccountBlock = {
    name: pluginPrefix + "_bank_account_gateway",
    label: <Label/>,
    content: <Content/>,
    edit: <Content/>,
    canMakePayment: () => true,
