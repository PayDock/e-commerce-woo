...
class CardProcessor
{
    ...
    public function getStandalone3dsToken(): string
    {
        ...
        if (!empty($threeDsCharge['error']) || empty($threeDsCharge['resource']['data']['_3ds']['token'])) {
            ...
            throw new Exception(__('The 3ds charge could not be created successfully.', POWER_BOARD_TEXT_DOMAIN));
        }
    ...
    private function customerCharge(): array
    {
        if ($this->customerId === null) {
            ...
            if (!empty($customer['error']) || empty($customer['resource']['data']['_id'])) {
                ...
                throw new Exception(__('The PowerBoard customer could not be created successfully.'.$message, POWER_BOARD_TEXT_DOMAIN));
            }
        ...
        if (!empty($responce['error'])) {
            ...
            throw new Exception(__('The charge could not be created successfully.', POWER_BOARD_TEXT_DOMAIN));
        }
