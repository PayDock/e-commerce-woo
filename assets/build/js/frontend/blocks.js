...
/***/ "./resources/js/includes/components/cvv-code.js":
/*!******************************************************!*\
  !*** ./resources/js/includes/components/cvv-code.js ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((label = 'Security number') => {
  ...
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Please enter a valid CVV code.'))));
});
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((selectTokenLabel = 'Saved bank accounts', newCardLabel = 'New Account') => {
  const settings = (0,_woocommerce_settings__WEBPACK_IMPORTED_MODULE_1__.getSetting)('paydock_bank_account_block_data', {});
  ...
  }, selectTokenLabel), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_select__WEBPACK_IMPORTED_MODULE_2__["default"], {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((selectTokenLabel = 'Saved cards', newCardLabel = 'New card') => {
  const settings = (0,_woocommerce_settings__WEBPACK_IMPORTED_MODULE_1__.getSetting)('paydock_data', {});
  if (!settings.hasOwnProperty('tokens') || typeof settings.tokens !== "object") {
    return '';
  }
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "paydock-select-saved-cards"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("label", {
    style: {
      fontSize: '1rem',
      fontWeight: 'bold',
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (async () => {
  const data = {
    ...(0,_woocommerce_settings__WEBPACK_IMPORTED_MODULE_0__.getSetting)('paydock_data', {})
  };
...
/* harmony import */ var _sleep__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./sleep */ "./resources/js/includes/sleep.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (async (forcePermanentVault = false, newAmount = null) => {
  var _shippingAddress$emai;
  ...
  const cart = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_3__.select)(_woocommerce_block_data__WEBPACK_IMPORTED_MODULE_4__.CART_STORE_KEY);
  ...
  const preAuthData = {
    ...
    shipping: {
      ...
      contact: {
        ...
        email: (_shippingAddress$emai = shippingAddress.email) !== null && _shippingAddress$emai !== void 0 ? _shippingAddress$emai : billingAddress.email
      }
    }
  };
  ...
  for (let second = 1; second <= 10000; second++) {
    await (0,_sleep__WEBPACK_IMPORTED_MODULE_2__["default"])(100);
    if (result !== false) {
      break;
    }
  }
...
/* harmony import */ var _sleep__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./sleep */ "./resources/js/includes/sleep.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (async () => {
  ...
  for (let second = 1; second <= 10000; second++) {
    await (0,_sleep__WEBPACK_IMPORTED_MODULE_3__["default"])(100);
    if (result !== false) {
      break;
    }
  }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   checkboxSavedApmsComponent: () => (/* reexport safe */ _components_checkbox_saved_apms__WEBPACK_IMPORTED_MODULE_10__["default"]),
/* harmony export */   checkboxSavedBankAccountComponent: () => (/* reexport safe */ _components_checkbox_saved_bank_account__WEBPACK_IMPORTED_MODULE_9__["default"]),
/* harmony export */   checkboxSavedCardsComponent: () => (/* reexport safe */ _components_checkbox_saved_cards__WEBPACK_IMPORTED_MODULE_7__["default"]),
/* harmony export */   cvvCode: () => (/* reexport safe */ _components_cvv_code__WEBPACK_IMPORTED_MODULE_6__["default"]),
...
/* harmony export */   selectSavedBankAccountsComponent: () => (/* reexport safe */ _components_select_saved_bank_accounts__WEBPACK_IMPORTED_MODULE_8__["default"]),
...
/* harmony import */ var _components_cvv_code__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/cvv-code */ "./resources/js/includes/components/cvv-code.js");
/* harmony import */ var _components_checkbox_saved_cards__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/checkbox-saved-cards */ "./resources/js/includes/components/checkbox-saved-cards.js");
/* harmony import */ var _components_select_saved_bank_accounts__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/select-saved-bank-accounts */ "./resources/js/includes/components/select-saved-bank-accounts.js");
/* harmony import */ var _components_checkbox_saved_bank_account__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/checkbox-saved-bank-account */ "./resources/js/includes/components/checkbox-saved-bank-account.js");
/* harmony import */ var _components_checkbox_saved_apms__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./components/checkbox-saved-apms */ "./resources/js/includes/components/checkbox-saved-apms.js");
...
const settings = (0,_woocommerce_settings__WEBPACK_IMPORTED_MODULE_3__.getSetting)('paydock_data', {});
const textDomain = 'paydock';
const labels = {
  defaultLabel: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Paydock Payments', textDomain),
  saveCardLabel: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Save payment details', textDomain),
  selectTokenLabel: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Saved payment details', textDomain),
  fillDataError: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Please fill in the card data.', textDomain),
  fillCCDataError: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Please fill in the required credit card form fields', textDomain),
  requiredDataError: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Please fill in the required fields of the form to display payment methods', textDomain),
  additionalDataRejected: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Payment has been rejected by Paydock. Please try again in a few minutes', textDomain)
};
const label = (0,_wordpress_html_entities__WEBPACK_IMPORTED_MODULE_2__.decodeEntities)(settings.title) || labels.defaultLabel;
...
const Content = props => {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_4__.useEffect)(() => {
    ...
    const validation = onCheckoutValidation(async () => {
      ...
      if (!window.widgetReloaded && settings.selectedToken.length > 0) {
        ...
        if (!!selectedToken && selectedToken.hasOwnProperty('customer_id')) {
          ...
          if (['IN_BUILD', 'STANDALONE'].includes(settings.card3DS)) {
            settings.charge3dsId = settings.card3DS === 'IN_BUILD' ? await (0,_includes_wc_paydock__WEBPACK_IMPORTED_MODULE_5__.inBuild3Ds)(true, newAmount) : await (0,_includes_wc_paydock__WEBPACK_IMPORTED_MODULE_5__.standalone3Ds)();
      ...
      for (let second = 1; second <= 100; second++) {
        await (0,_includes_wc_paydock__WEBPACK_IMPORTED_MODULE_5__.sleep)(100);
      ...
      if (result) {
        if (['IN_BUILD', 'STANDALONE'].includes(settings.card3DS)) {
          settings.charge3dsId = settings.card3DS === 'IN_BUILD' ? await (0,_includes_wc_paydock__WEBPACK_IMPORTED_MODULE_5__.inBuild3Ds)(false, newAmount) : await (0,_includes_wc_paydock__WEBPACK_IMPORTED_MODULE_5__.standalone3Ds)();
          if (settings.charge3dsId === false) {
            return {
              type: emitResponse.responseTypes.ERROR,
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_4__.createElement)('div', null, (0,react__WEBPACK_IMPORTED_MODULE_4__.createElement)("div", null, (0,_wordpress_html_entities__WEBPACK_IMPORTED_MODULE_2__.decodeEntities)(settings.description || '')), (0,_includes_wc_paydock__WEBPACK_IMPORTED_MODULE_5__.selectSavedCardsComponent)(labels.selectTokenLabel), (0,react__WEBPACK_IMPORTED_MODULE_4__.createElement)("div", {
    id: 'paydockWidgetCard_wrapper'
  }), (0,react__WEBPACK_IMPORTED_MODULE_4__.createElement)("div", {
    id: 'paydockWidget3ds'
  }), (0,react__WEBPACK_IMPORTED_MODULE_4__.createElement)("input", {
    type: 'hidden',
...
const Label = props => {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_4__.createElement)(PaymentMethodLabel, {
    text: label
  });
};
const Paydok = {
...
(0,_woocommerce_blocks_registry__WEBPACK_IMPORTED_MODULE_1__.registerPaymentMethod)(Paydok);
/******/ })()
;
