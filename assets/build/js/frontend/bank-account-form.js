...
const labels = {
  ...
  saveBankAcoountLabel: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Save payment details', textDomain),
  selectTokenLabel: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Saved payment details', textDomain),
  fillDataError: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Please fill in the card data.', textDomain)
};
const label = (0,_wordpress_html_entities__WEBPACK_IMPORTED_MODULE_3__.decodeEntities)(settings.title) || label.defaultLabel;
let sleepSetTimeout_ctrl;
function sleep(ms) {
  clearInterval(sleepSetTimeout_ctrl);
  return new Promise(resolve => sleepSetTimeout_ctrl = setTimeout(resolve, ms));
...
const Content = props => {
  ...
  })), (0,_includes_wc_paydock__WEBPACK_IMPORTED_MODULE_5__.selectSavedBankAccountsComponent)(labels.selectTokenLabel), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    id: 'paydockWidgetBankAccount_wrapper'
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    type: 'hidden',
    name: 'payment_source_bank_account_token'
  }), (0,_includes_wc_paydock__WEBPACK_IMPORTED_MODULE_5__.checkboxSavedBankAccountComponent)(labels.saveBankAcoountLabel));
};
const Label = props => {
  const {
    PaymentMethodLabel
