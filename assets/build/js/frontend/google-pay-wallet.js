...
/***/ "./resources/js/includes/wallets-form.js":
/*!***********************************************!*\
  !*** ./resources/js/includes/wallets-form.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _wallets_validate_form__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./wallets/validate-form */ "./resources/js/includes/wallets/validate-form.js");
/* harmony import */ var _wallets_init__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./wallets/init */ "./resources/js/includes/wallets/init.js");
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! axios */ "./node_modules/axios/lib/axios.js");
/* harmony import */ var _canMakePayment__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./canMakePayment */ "./resources/js/includes/canMakePayment.js");
...
const labels = {
  ...
  fillDataError: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('The payment service does not accept payment. Please try again later or choose another payment method.', textDomain),
  notAvailable: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Payment method is not avalaible for your country!!!', textDomain)
};
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((id, defaultLabel, buttonId, dataFieldsRequired) => {
  ...
  const store = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_4__.select)(_woocommerce_block_data__WEBPACK_IMPORTED_MODULE_5__.CHECKOUT_STORE_KEY);
  const cart = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_4__.select)(_woocommerce_block_data__WEBPACK_IMPORTED_MODULE_5__.CART_STORE_KEY);
  let button;
  const initWallet = () => {
    ...
    axios__WEBPACK_IMPORTED_MODULE_10__["default"].post('/wp-json/paydock/v1/wallets/charge', billingData).then(response => {
      localState.initData = response.data;
      setTimeout(() => {
        (0,_wallets_init__WEBPACK_IMPORTED_MODULE_8__["default"])(id, '#' + buttonId, localState.initData, settings.isSandbox, localState.reload);
      }, 0);
    }).catch(_e => {
  ...
  const Content = props => {
    ...
    let validationSuccess = (0,_wallets_validate_form__WEBPACK_IMPORTED_MODULE_7__["default"])(billingAddress, dataFieldsRequired);
    jQuery('.wc-block-components-checkout-place-order-button').hide();
    if ('paydockWalletAfterpayButton' === buttonId && validationSuccess && !afterpayCountries.find(element => element === billingAddress.country.toLowerCase())) {
      ...
      afterpayCountriesError.hide();
      setTimeout(() => {
        (0,_wallets_init__WEBPACK_IMPORTED_MODULE_8__["default"])(id, '#' + buttonId, localState.initData, settings.isSandbox);
      }, 0);
    }
    (0,react__WEBPACK_IMPORTED_MODULE_6__.useEffect)(() => {
      const onShipping = onShippingRateSelectSuccess(async () => {
        ...
        if (storedTotalPrice !== currentTotalPrice && (0,_canMakePayment__WEBPACK_IMPORTED_MODULE_9__["default"])(settings.total_limitation, currentTotalPrice)) {
          initWallet();
        }
      });
    ...
    const description = (0,react__WEBPACK_IMPORTED_MODULE_6__.createElement)("div", null, (0,_wordpress_html_entities__WEBPACK_IMPORTED_MODULE_2__.decodeEntities)(settings.description || ''));
    const input = (0,react__WEBPACK_IMPORTED_MODULE_6__.createElement)("input", {
      type: 'hidden',
      id: 'paymentSourceWalletsToken'
    });
    const paymentWasSuccessElement = (0,react__WEBPACK_IMPORTED_MODULE_6__.createElement)('div', {
      id: 'paymentCompleted',
      style: {
        display: 'none',
    ...
    const wallets = [(0,react__WEBPACK_IMPORTED_MODULE_6__.createElement)('div', {
      id: buttonId,
      class: "paudock-wallets-buttons"
    })];
    return (0,react__WEBPACK_IMPORTED_MODULE_6__.createElement)('div', null, description, paymentWasSuccessElement, (0,react__WEBPACK_IMPORTED_MODULE_6__.createElement)('div', {
      id: 'paydockWidgetWallets',
      class: 'paydock-widget-content'
    }, ...wallets), (0,react__WEBPACK_IMPORTED_MODULE_6__.createElement)('div', {
      class: 'paydock-validation-error',
      style: {
        display: validationSuccess ? 'none' : ''
      }
    }, labels.validationError), (0,react__WEBPACK_IMPORTED_MODULE_6__.createElement)("div", {
      class: 'paydock-country-available',
      style: {
        display: 'none'
      }
    }, labels.notAvailable), input);
  };
  const PaydokWalletBlock = {
    name: paymentName,
    label: (0,react__WEBPACK_IMPORTED_MODULE_6__.createElement)(() => (0,react__WEBPACK_IMPORTED_MODULE_6__.createElement)("div", {
      className: 'paydock-payment-method-label'
    }, (0,react__WEBPACK_IMPORTED_MODULE_6__.createElement)("img", {
      src: `/wp-content/plugins/paydock/assets/images/icons/${id}.png`,
      alt: label,
      className: `paydock-payment-method-label-icon ${id}`
    }), "  " + label)),
    content: (0,react__WEBPACK_IMPORTED_MODULE_6__.createElement)(Content, null),
    edit: (0,react__WEBPACK_IMPORTED_MODULE_6__.createElement)(Content, null),
    canMakePayment: () => true,
    ariaLabel: label,
    supports: {
  ...
  (0,_woocommerce_blocks_registry__WEBPACK_IMPORTED_MODULE_1__.registerPaymentMethod)(PaydokWalletBlock);
});

/***/ }),

/***/ "./resources/js/includes/wallets/init.js":
/*!***********************************************!*\
  !*** ./resources/js/includes/wallets/init.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
let buttons = {};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((id, buttonId, data, isSandbox) => {
...
/*!****************************************************!*\
  !*** ./resources/js/frontend/google-pay-wallet.js ***!
  \****************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _includes_wallets_form__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../includes/wallets-form */ "./resources/js/includes/wallets-form.js");

(0,_includes_wallets_form__WEBPACK_IMPORTED_MODULE_0__["default"])('google-pay', 'Paydock Google Pay', 'paydockWalletGooglePayButton', ['first_name', 'last_name', 'email', 'address_1', 'city', 'state', 'country', 'postcode']);
/******/ })()
;
//# sourceMappingURL=google-pay-wallet.js.map