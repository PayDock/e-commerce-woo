jQuery(window).on('load', function () {
    const json = {
        "options": [{
            "image": `${window.widgetSettings.pluginUrlPrefix}assets/images/ausbc.png`,
            "title": "Australian Bank Card",
            "type": "ausbc"
        }, {
            "image": `${window.widgetSettings.pluginUrlPrefix}assets/images/diners.png`,
            "title": "Diner's Club, Diner's Club International, Diner's Club / Carte Blanche",
            "type": "diners"
        }, {
            "image": `${window.widgetSettings.pluginUrlPrefix}assets/images/japcb.png`,
            "title": "Japanese Credit Bureau",
            "type": "japcb"
        }, {
            "image": `${window.widgetSettings.pluginUrlPrefix}assets/images/maestro.png`, "title": "Maestro", "type": "maestro"
        }, {
            "image": `${window.widgetSettings.pluginUrlPrefix}assets/images/laser.png`, "title": "Laser", "type": "laser"
        }, {
            "image": `${window.widgetSettings.pluginUrlPrefix}assets/images/solo.png`, "title": "Solo (Paymentech)", "type": "solo"
        }, {
            "image": `${window.widgetSettings.pluginUrlPrefix}assets/images/mastercard.png`,
            "title": "MasterCard",
            "type": "mastercard"
        }, {
            "image": `${window.widgetSettings.pluginUrlPrefix}assets/images/discover.png`, "title": "Discover", "type": "discover"
        }, {
            "image": `${window.widgetSettings.pluginUrlPrefix}assets/images/amex.png`, "title": "American Express", "type": "amex"
        }, {
            "image": `${window.widgetSettings.pluginUrlPrefix}assets/images/visa.png`,
    ...
    const createOptions = () => {
        const dropdown = document.getElementById('multiselect-plugin')
        if (dropdown === null) {
            return
        }
    ...
    `
        json.options.map((option, index) => {
            ...
            itemLi.innerHTML = `
            <input type="checkbox" id="plugin-card-type-${index}" value="${option.type}" class="checkbox">
            <label for="plugin-card-type-${index}">
    ...
    const multiselect = document.querySelectorAll('.multiselect-plugin')
